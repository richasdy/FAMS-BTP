...
public class SearchData extends Fragment {
    ...
    TextView tipeAset;
    @BindView(R.id.txtMerkAset)
    TextView merk;
    @BindView(R.id.btnCari)
    Button cari;
    @BindView(R.id.gambarAset)
    ImageView gambar;
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (dataJson.getString("status").equals("success")) {
                                ...
                                merk.setText("Merk : " + data.getString("merk"));
                                if (!data.getString("image").equals("null")) {
                                    byte[] anotherArrayBytes = ConvertSimpleImage.stringBase64ToBytes(data.getString("image"));
